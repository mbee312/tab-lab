...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    autoprefixer: {
      ...
      docs: {
        src: ['docs/assets/styles/anchor.css', 'docs/assets/styles/src/docs.css']
      },
      examples: {
        expand: true,
        cwd: 'docs/examples/',
    ...
    cssmin: {
      ...
      docs: {
        src: [
          ...
          'docs/assets/styles/src/anchor.css',
    ...
    htmllint: {
      options: {
        ignore: [
          ...
          'Element "media" is missing required attribute "src".'
        ]
      },
      src: '_gh_pages/**/*.html'
    },
  ...
  grunt.registerTask('dist-styles', ['less-compile', 'autoprefixer:core', 'autoprefixer:theme', 'usebanner', 'csscomb:dist', 'cssmin:minifyCore', 'cssmin:minifyTheme']);
