          ...
          return $timeout(function () {
            ...
            customPaging = function (slick, index) {
              ...
              if (winWidth < 350) {
                  ...
                  overrideSetings.arrows = false;
              }
              else if (winWidth < 769) {
                  overrideSetings.slidesToShow = 3;
                  overrideSetings.arrows = false;
              }
            ...
            slider.on('init', function (sl) {
              ...
              if (sl && sl.slideHandler && currentIndex != null) {
                return sl.slideHandler(currentIndex);
              }
            });
            slider.on('afterChange', function (event, slick, currentSlide, nextSlide) {
              var data = {event: event, slick: slick, currentSlide: currentSlide, nextSlide: nextSlide};
              $rootScope.$broadcast("slickOnAfterChange", data);
